...
alias l='ls'
alias l.="ls -A | egrep '^\.'"
alias ls='lsd -la1F' # long listing, show hidden files, one per line
...
#edit file while keeping current shell open
...
#search idiotbox
alias w3cm='w3m codemadness.org/idiotbox'
...
#launch menu
alias menu='python ~/scripts/menu.py'
